package com.sample.blospot.ui.auth.state
...
data class RegistrationFields(
    ...
    var registration_passsword: String? = null,
    ...
    fun isValidForRegistration(): String {
        if (registration_email.isNullOrEmpty()
            ...
            || registration_passsword.isNullOrEmpty()
            || registration_confirm_password.isNullOrEmpty()
        ) {
            return RegistrationError.mustFillAllFields()
        }

        if (!registration_passsword.equals(registration_confirm_password)) {
            return RegistrationError.passwordsDoNotMuch()
        }
